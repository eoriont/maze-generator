...
function draw() {
  ...
  for (let i of maze) {
    ...
    if (!i.up) {
      line(x*width/mazeW, y*height/mazeH, (x+1)*width/mazeW, y*height/mazeH);
    }
    if (!i.down) {
      line(x*width/mazeW, (y+1)*height/mazeH, (x+1)*width/mazeW, (y+1)*height/mazeH);
    }
    if (!i.right) {
      line((x+1)*width/mazeW, y*height/mazeH, (x+1)*width/mazeW, (y+1)*height/mazeH);
    }
    if (!i.left) {
      line(x*width/mazeW, y*height/mazeH, x*width/mazeW, (y+1)*height/mazeH);
    }
    if (i.start) {
      push();
      noStroke();
      fill("green");
      rect(x*width/mazeW, y*height/mazeH, width/mazeW, height/mazeH);
      pop();
    }
    if (i.end) {
      push();
